...
namespace Demo4.Controllers
{
    public class OgrencisController : Controller
    {
        ...
        public OgrencisController(MyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("OgrenciId,AdSoyad")] Ogrenci ogrenci)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OgrenciId,AdSoyad")] Ogrenci ogrenci)
        {
